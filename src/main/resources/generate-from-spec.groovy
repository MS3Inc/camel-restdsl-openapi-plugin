...
def oasPath = FilePaths.get(baseDir + '/' +  'src/generated/api/').toFile()
oasPath.mkdirs();
...
def rGenPath = baseDir + '/src/generated/java/' + (groupId).replaceAll("\\.", "/").replaceAll("-", "_") + '/RoutesGenerated.java'
...
// TODO fix this so groupId replacement is done just once


// Read the RoutesImplemented placeholder file.
def rImpPath = baseDir + '/src/main/java/' + (groupId).replaceAll("\\.", "/").replaceAll("-", "_") + '/RoutesImplementation.java'
...
def gitignorePath = baseDir + '/.gitignore'
